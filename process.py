# ============================================================================
# Joe Pringle (661114638), CSCI-4210 OpSys, process.py
# ============================================================================
...
def switches(old, new, time):
    ...
    """
    if (old is None):
        print("[time {}ms] Context switch (Adding process {}, no process"
              " currently in CPU)".format(time, new.pid))
    else:
        print("[time {}ms] Context switch (swapping out process {} for"
              " process {})".format(time, old.pid, new.pid))
